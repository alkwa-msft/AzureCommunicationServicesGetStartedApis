...
{
	public static class GetChatThreadProperties
    {
        [FunctionName("Chat-GetChatThreadProperties")]
            ...
            ILogger log)
        {
            ...
            try
            {
                ...
                Response<ChatThreadProperties> chatThreadPropertiesResponse = await threadClient.GetPropertiesAsync();
                return new OkObjectResult(chatThreadPropertiesResponse.Value);
            }
